...
if __name__ == "__main__":
    ...
    params = {
        "name_dataset": "ms_coco_200_epochs",
        "name_embedding": "clip_vit",
        "format_file": "hdf5",
        "dataset_path": "./Data/ms_coco_embeddings.hdf5",
 	"documents_key" : "images",
        "algorithm": "random",
        "nclusters": 307,  # Square root of dataset size
        "top_k": 1,
        "ells": "1,2,3",  # Fraction of clusters examined
